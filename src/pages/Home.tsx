                ...
                <div className={`${xl ? 'w-10/12' : ''}`}>
                  ...
                  <div className="flex items-center">
                    ...
                    <IconButton
                      ...
                      {love ? (
                        <FavoriteIcon style={{ color: '#ff6969' }} />
                      ) : (
                        <FavoriteBorderIcon />
                      )}
                    </IconButton>
                  ...
                  <div>
                    <span className={`leading-relaxed ${!sm && 'text-xs'}`}>
                      ...
                      currently working as a front-end developer at a company in Bangkok, Thailand.
                      I have a lot of experience in web development and I'm constantly learning new
